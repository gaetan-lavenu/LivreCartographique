...
String[] serverUrls = {
  ...
  "http://sampleserver1.arcgisonline.com/arcgis/rest/services","http://server.arcgisonline.com",
  "http://feed.netatmo.net","http://servicesbeta.esri.com" //NOTE - no comma after the last item
};
%>
<%
try {
