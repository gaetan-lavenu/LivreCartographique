...
define([
    ...
    return declare([], {
        _renderPages: function(pages) {
            ...
            mapBookUList = domConstruct.create("ul", {
                "id": "mapBookPagesUList",
                "class": "esriMapBookUList"
            }, null);
        ...
        _renderPage: function(page) {
            var _self = this,
                listItem, pageHeight, currentPage, currentPageContainer;
            listItem = domConstruct.create("li", {
                "class": "esriMapBookPageListItem"
            }, null);
            dom.byId("mapBookPagesUList").appendChild(listItem);
            this.currentIndex = page.index;
            currentPageContainer = domConstruct.create("div", {
                "class": "esriMapBookPage",
        ...
        _renderEditPage: function() {
            ...
            divEditPage = domConstruct.create("div", {
                "class": "esriMapBookEditPage"
            }, dom.byId('esriMapPages'));
            divEditPageHeader = domConstruct.create("div", {
                "class": "esriEditPageHeader"
            }, divEditPage);
            divEditPageList = domConstruct.create("div", {
                "class": "esriEditPageOptionList"
            }, divEditPageHeader);
            if (dojo.bookInfo[dojo.currentBookIndex].BookConfigData.CoverPage) {
                imgOptionList = domConstruct.create("div", {
                    "class": "esriEditPageOptionListImg"
                }, divEditPageList);
                imgEditCoverPage = domConstruct.create("div", {
                    "index": 0,
                    "class": "esriEditPageImg esriBookPage esriPageSelected",
                    "style": "background:url('themes/images/coverpage.png')"
                }, imgOptionList);
                imgEditCoverPage.innerHTML = "Couverture";
            ...
            imgEditContentPage = domConstruct.create("div", {
                "index": 1,
                "class": "esriEditPageImg esriBookPage",
                "style": "background:url('themes/images/content-temp.png')"
            }, imgOptionList);
            imgEditContentPage.innerHTML = "Table des matières";
            ...
            divAddNewPage = domConstruct.create("div", {
                "class": "esriAddNewPageDiv"
            }, divEditPageHeader);
            domConstruct.create("div", {
                "class": "esriAddNewPageImg"
            }, divAddNewPage);
            domConstruct.create("div", {
                "class": "esriAddNewPageLabel",
                "innerHTML": nls.addPageTitle
            }, divAddNewPage);
            divEditPageBody = domConstruct.create("div", {
                "class": "esriEditPageBody"
            }, divEditPage);
            divPageSlider = domConstruct.create("div", {
                "class": "esriPageSliderContainer"
            }, divEditPageHeader);
        ...
        _renderTemplateOptionPage: function(divEditPageBody, configLayout, isBookPageLayout) {
            var _self = this,
                divTitle, divOuter, layoutType, templateType, divTemplateContainer, divTemplatelist, divEditPageBodyContent, divEditPageFooter, divAddPage, divCancel, tempIndex;
            if (isBookPageLayout) {
                layoutType = "pageLayoutOption";
            } else {
                layoutType = "contentLayoutOption";
            }
            divEditPageBodyContent = domConstruct.create("div", {
                "class": layoutType
            }, divEditPageBody);
            divTitle = domConstruct.create("div", {
                "class": "esriLabelSelectlayout",
                "innerHTML": nls.selectAnyLayout
            }, divEditPageBodyContent);
            divOuter = domConstruct.create("div", {
                "class": "esriTemplateOuterDiv"
            }, divEditPageBodyContent);
            array.forEach(configLayout, function(layoutOption, index) {
                divTemplateContainer = domConstruct.create("div", {
                    "class": "esriTemplateContainer"
                }, divOuter);
                divTemplatelist = domConstruct.create("img", {
                    "isBookPageLayout": isBookPageLayout,
                    "class": "esriTemplateImage",
                    "src": layoutOption.templateIcon,
                    "index": index
            ...
            divEditPageFooter = domConstruct.create("div", {
                "class": "esriEditPageFooter"
            }, divEditPageBodyContent);
            divAddPage = domConstruct.create("div", {
                "isBookPageLayout": isBookPageLayout,
                "class": "esriAddBtn",
                "innerHTML": nls.addPageText
            }, divEditPageFooter);
            divCancel = domConstruct.create("div", {
                "class": "esriCancelBtn",
                "innerHTML": nls.cancelButtonText
            }, divEditPageFooter);
        ...
        _createNewPage: function(isBookPageLayout) {
            var selectedTempIndex, newPage = {}, pageIndex, flag = false,
                currentPageIndex = this.currentIndex;
            ...
            if (isBookPageLayout) {
                ...
                newPage.title = "Table des matières";
                if (dojo.bookInfo[dojo.currentBookIndex].BookConfigData.ContentPage) {
        ...
        _deletePage: function() {
            var selectedPage, pageModuleContent, bookPages, bookPageIndex, _self = this,
                moduleData, pageIndex = this.currentIndex,
                index;
            if (this.mapBookDetails[dojo.currentBookIndex][1] === "EmptyContent") {
                pageIndex--;
            }
