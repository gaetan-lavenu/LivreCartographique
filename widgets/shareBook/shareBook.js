...
define([
    ...
    return declare([_WidgetBase], {
        ...
        _createShareBookDialog: function() {
            var btnContainer, shareBookDialog, btnShare, _self = this,
                optionIndex, divShareDialogOptionList, divCheckBox,
            ...
            shareOptions = [{
                "key": "everyone",
                "label": nls.shareToEveryoneText
            }, {
                "key": "org",
                "label": nls.shareToOrgText
            }, {
                "key": "copyProtected",
                "label": nls.protectCopyBookText
            }];
            for (optionIndex = 0; optionIndex < shareOptions.length; optionIndex++) {
                divShareDialogOptionList = domConstruct.create("div", {
                    "class": "esriShareDialogOptionList"
                }, divShareDialogContent);
                divCheckBox = domConstruct.create("div", {
                    "id": "chkBox" + shareOptions[optionIndex].key,
                    "class": "esriCheckBox",
                    "key": shareOptions[optionIndex].key
                }, divShareDialogOptionList);
                on(divCheckBox, "click", function() {
                    _self._toggleSharingCheckbox(this);
                });
                divCheckBoxLabel = domConstruct.create("div", {
                    "class": "esriCheckBoxLabel",
                    "innerHTML": shareOptions[optionIndex].label
                }, divShareDialogOptionList);
            }

            btnContainer = domConstruct.create("div", {
                "class": "esriButtonContainer"
            }, divShareDialogContent);
            btnShare = domConstruct.create("div", {
                "class": "esriSelectWebmapBtn",
                "innerHTML": "Partager"
            }, btnContainer);
        ...
        _sendEsriSharingRequest: function() {
            var _self = this,
                currentItemId, queryParam, requestUrl;
            queryParam = {
                itemType: "text",
                f: 'json',
