...
define([
    ...
    return declare([_WidgetBase, mapbookUtility], {
        ...
        _createSelectWebmapDialog: function(container) {
            ...
            divSelectWebMapContainer = domConstruct.create("div", {
                "class": "esriSelectWebmapContainer"
            }, null);
            divSearchOption = domConstruct.create("div", {
                "class": "esriSearchWebmapOptions"
            }, divSelectWebMapContainer);
            this._createtWebmapSearchDropdown(divSearchOption);
            this._createWebmapSearchBox(divSearchOption);
            domConstruct.create("div", {
                "id": "divWebmapContent",
                "class": "esriWebmapContent"
            }, divSelectWebMapContainer);
        ...
        _createPaginationFooter: function(divSelectWebMapContainer) {
            ...
            divPaginationFooter = domConstruct.create("div", {
                "class": "esriWebmapPagination"
            }, divSelectWebMapContainer);
            divInnerPaginationFooter = domConstruct.create("div", {
                "class": "esriPaginationInnerDiv"
            }, divPaginationFooter);
            divWebmapCount = domConstruct.create("div", {
                "class": "esriWebmapCountDiv"
            }, divInnerPaginationFooter);
            divPrev = domConstruct.create("div", {
                "class": "esriPaginationPrevious disableNavigation",
                "innerHTML": "<span class='esriPaginationText'>Précédent<span>"
            }, divInnerPaginationFooter);
            divPageStatus = domConstruct.create("div", {
                "class": "esriCurrentPageStatus"
            }, divInnerPaginationFooter);
            divNext = domConstruct.create("div", {
                "class": "esriPaginationNext disableNavigation",
                "innerHTML": "<span class='esriPaginationText'>Suivant</span>"
            }, divInnerPaginationFooter);
        ...
        _createWebMapDialogContent: function(response) {
            var pageIndex, webMapURL, _self = this,
                webmapIndex, divWebmapPage, divWebmapThumbnail, imgWebmapDescript, imgWebmapThumbnail, pageWidth,
            ...
            if (response.results.length > 0) {
                for (pageIndex = 0; pageIndex < noOfpages; pageIndex++) {
                    divWebmapPage = domConstruct.create("div", {
                        "pageIndex": pageIndex,
                        "class": "esriWebmaplistPage"
                    }, dom.byId("divWebmapContent"));
                    if (pageIndex !== 0) {
                    ...
                    for (pageContentIndex = 0; pageContentIndex < dojo.appConfigData.webmapPerPage; pageContentIndex++) {
                        if (response.results[webmapIndex]) {
                            divWebmapThumbnail = domConstruct.create("div", {
                                "class": "esriWebmapThumbnailDiv"
                            }, divWebmapPage);
                            imgWebmapThumbnail = domConstruct.create("img", {
                                "src": response.results[webmapIndex].thumbnailUrl,
                                "class": "esriWebmapThumbnail"
                            }, divWebmapThumbnail);
                            ...
                            domConstruct.create("div", {
                                "class": "esriWebmapTitle",
                                "innerHTML": response.results[webmapIndex].title
                            }, divWebmapThumbnail);
                            imgWebmapDescript = domConstruct.create("div", {
                                "class": "esriWebmapDescript"
                            }, divWebmapThumbnail);
        ...
        _setPaginationDetails: function(pageIndex) {
            ...
            if (webmapCount) {
                webmapCountDetails = dojo.string.substitute(nls.webmapCountStatus, {
                    "start": startIndex,
                    "end": webmapCount,
                    "total": totalWebmap
                });
        ...
        _createWebmapSearchBox: function(divSearchOption) {
            ...
            dijitInputContainer = new TextBox({
                "id": "searchTagTextBox",
                "class": "esriSearchWebmapTextBox"
            }, divInputContainer);
            dijitInputContainer.textbox.placeholder = nls.searchWebmapPlaceHolder;
            dijitInputContainer.startup();
            btnSearch = domConstruct.create("div", {
                "class": "esriSearchWebmapBtn",
                "innerHTML": "Rechercher"
            }, null);
